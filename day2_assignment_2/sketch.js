...
function setup() {
  ...
  startTime = millis();
  x1= 0, x2= 0, x3= 0, y1= 0, y2= 0, y3 = 0, z1=0, z2=0, z3=0, t1=0, t2=0, t3=0, r=32, g=2, b=2, maxR = 255, maxG = 20, maxB = 40;
  frameRate(60);
}
...
fill(180, 21, 0, 220);
triangle(150, 300, 450, 300, (frameCount/100)*300,(frameCount/100)*300);
fill(r+150, g+70, b+100, 220);
triangle(150, 300, 350, 300, 200,100);
triangle(250, 300, 450, 300, 400,100);
